...
OUT_NPY_FEATS = "/home/user4/Kaggle_Project/ck_train_mediapipe_feats.npy"
OUT_NPY_LABELS = "/home/user4/Kaggle_Project/ck_train_labels.npy"
OUT_CSV = "/home/user4/Kaggle_Project/ck_train_mediapipe_feats.csv"
...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        coords = np.array([[lm.x, lm.y, lm.z] for lm in face_landmarks],
                          dtype=np.float32)
        feat_vec = coords.flatten()   # (num_landmarks * 3,)
    ...
    all_labels = np.array(all_labels, dtype=int) # (N,)

    # Save as .npy (optional, like before)
